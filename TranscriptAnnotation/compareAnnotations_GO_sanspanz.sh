...
#Usage: bash compareAnnotations_GO_sanspanz.sh annotationFile1 annotationFile2 annotationFile3
#Usage ex: bash compareAnnotations_GO_sanspanz.sh PA42_proteins/user_GO.txt PA42_cds/user_GO.txt PA42_transcripts/user_GO.txt
