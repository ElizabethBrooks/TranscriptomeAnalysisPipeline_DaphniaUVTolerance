...
co = column_order(ht)
nc = ncol(size)
pdf("/home/mae/Documents/RNASeq_Workshop_ND/genomicResources_PA42_v4.1/geneCounts_mergedHisat2_PA42_v4.1/plotIntersection_combinedDDR_UVR_2UpNums_PA42_v4.1.pdf")
...
co = column_order(ht)
nc = ncol(m)
pdf("/home/mae/Documents/RNASeq_Workshop_ND/genomicResources_PA42_v4.1/geneCounts_mergedHisat2_PA42_v4.1/plotGLMQLF_combinedDDR_2UpNums_PA42_v4.1.pdf")
plot <- decorate_annotation("Intersection\nsize", {
  grid.text(cs[co], 
            x = 1:nc, 
            y = unit(cs[co], "native") + unit(1, "mm"), 
...
co = column_order(ht)
nc = ncol(m)
pdf("/home/mae/Documents/RNASeq_Workshop_ND/genomicResources_PA42_v4.1/geneCounts_mergedHisat2_PA42_v4.1/plotIntersection_combinedDDR_UVR_nums_PA42_v4.1.pdf")
plot <- decorate_annotation("Intersection\nsize", {
  grid.text(cs[co], 
            x = 1:nc, 
            y = unit(cs[co], "native") + unit(1, "mm"), 
