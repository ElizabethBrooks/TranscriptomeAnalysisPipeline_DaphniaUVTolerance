...
for f1 in trimmed/*pForward.fq.gz; do
	hisat2 -q -p 8 -x aligned_hisat2/Daphnia_pulex.allmasked -1 $f1 -2 "${f1:0:${#f1}-14}"pReverse.fq.gz -S aligned_hisat2/out/"${f1:0:${#f1}-14}" --summary-file aligned_hisat2/alignedSummary.txt
done
