...
gCount1 = read.csv("../../GeneCounts_Merged/merged_counts_subset_tagged.csv", sep=",", row.names=1)
gCount2 = read.csv("../../GeneCounts_Merged/merged_counts_legacy_tagged.csv", sep=",", row.names=1)
