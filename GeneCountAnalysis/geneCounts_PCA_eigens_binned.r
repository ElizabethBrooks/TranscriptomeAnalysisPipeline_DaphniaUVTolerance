#!/usr/bin/env Rscript
#Usage: Rscript geneCounts_PCA_eigens_binned.r mergedCounts_file_transposed.csv bin SCALE
#Usage Ex: Rscript geneCounts_PCA_eigens_binned.r mergedCounts_legacy_transposed.csv treatment FALSE
...
autoplot(prcomp(gCount0[, names(gCount0)!=args[2]], scale.=args[3]), data=gCount0, colour=args[2], loadings=TRUE, 
