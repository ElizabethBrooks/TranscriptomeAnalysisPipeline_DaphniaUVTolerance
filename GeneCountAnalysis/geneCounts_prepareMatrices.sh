#!/bin/bash
#Usage: bash geneCounts_prepareMatrices.sh countedGenesFile
#Usage Ex: bash geneCounts_prepareMatrices.sh geneCounts_merged_counted_htseqTophat2_run1_fullset.txt
