#!/usr/bin/env Rscript
#Usage: Rscript geneCounts_PCA.r mergedCounts_file_transposed.csv SCALE
#Usage Ex: Rscript geneCounts_PCA.r mergedCounts_legacy_transposed.csv FALSE
...
autoplot(prcomp(gCount0, scale.=args[2]))