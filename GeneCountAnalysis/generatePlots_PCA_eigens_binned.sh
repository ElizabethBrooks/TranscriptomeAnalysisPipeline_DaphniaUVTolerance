...
#Usage Ex: bash generatePlots_PCA_eigens_binned.sh GeneCountAnalysis_subset_run1/geneCounts_merged_counted_htseqTophat2_run1_subset_transposed.csv treatment
