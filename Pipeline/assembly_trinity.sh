...
#Remove extra files generated by Trinity
rm "$outputFolder"/both.fa*
rm -r "$outputFolder"/chrysalis
rm "$outputFolder"/inchworm.*
rm -r "$outputFolder"/insilico_read_normalization
rm "$outputFolder"/jellyfish.*
rm "$outputFolder"/*.fa.*
rm "$outputFolder"/partitioned_reads.*
rm "$outputFolder"/*.cmds*
rm -r "$outputFolder"/read_partitions
rm "$outputFolder"/scaffolding_entries.sam
rm "$outputFolder"/Trinity.timing
