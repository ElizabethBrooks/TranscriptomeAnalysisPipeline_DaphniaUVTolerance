...
#blastp -query "$outputFolder"/Trinity.fasta.transdecoder_dir/longest_orfs.pep -db "$uniprotPath"  -max_target_seqs 1 -outfmt 6 -evalue 1e-5 -num_threads 8 > "$outputFolder"/blastp.outfmt6
