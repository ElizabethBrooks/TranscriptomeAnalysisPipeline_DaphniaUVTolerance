...
rm -r "$outputFolder"/trinity_out_dir/Dir_sorted.bam.minC1.gff
rm "$outputFolder"/trinity_out_dir/Dir_sorted*
rm "$outputFolder"/trinity_out_dir/sorted.bam*
rm "$outputFolder"/trinity_out_dir/partitions.ok
rm "$outputFolder"/trinity_out_dir/read_files.list*
rm "$outputFolder"/trinity_out_dir/trinity_GG.cmds*
#Move selected files up a directory for downstream analysis
mv "$outputFolder"/trinity_out_dir/Trinity.fasta ../
mv "$outputFolder"/trinity_out_dir/Trinity.fasta.gene_trans_map ../
#Final clean up
rm -r "$outputFolder"/trinity_out_dir
