...
bam.files <- list.files(path="/afs/crc.nd.edu/group/pfrenderlab/bateson/ebrooks/rnaseq/aligned_hisat2_run1", pattern="accepted_hits.bam", full.names=TRUE, recursive=TRUE)
