...
#sizeGrWindow(9,9)
jpeg("networkHeatmap_subset400.jpg", width = 960, height = 960)
...
#sizeGrWindow(5,7.5);
jpeg("moduleEigengenes_treatment.jpg", width = 960, height = 960)
par(cex = 0.9)
...
# Plot the dendrogram
#sizeGrWindow(6,6);
jpeg("eigengenesDendrogram_treatment.jpg", width = 960, height = 960)
par(cex = 1.0)
...
jpeg("eigengenesHeatmap_treatment.jpg", width = 960, height = 960)
par(cex = 1.0)
...
# Plot the relationships among the eigengenes and the trait
#sizeGrWindow(5,7.5);
jpeg("moduleEigengenes_tolerance.jpg", width = 960, height = 960)
par(cex = 0.9)
plotEigengeneNetworks(MET, "", marDendro = c(0,4,1,2), marHeatmap = c(3,4,1,2), cex.lab = 0.8, xLabelsAngle
                      = 90)
dev.off()
...
# Plot the dendrogram
#sizeGrWindow(6,6);
jpeg("eigengenesDendrogram_tolerance.jpg", width = 960, height = 960)
par(cex = 1.0)
plotEigengeneNetworks(MET, "Eigengene dendrogram", marDendro = c(0,4,2,0),
                      plotHeatmaps = FALSE)
dev.off()
...
# Plot the heatmap matrix (note: this plot will overwrite the dendrogram plot)
jpeg("eigengenesHeatmap_tolerance.jpg", width = 960, height = 960)
par(cex = 1.0)
plotEigengeneNetworks(MET, "Eigengene adjacency heatmap", marHeatmap = c(3,4,2,2),
                      plotDendrograms = FALSE, xLabelsAngle = 90)
dev.off()
