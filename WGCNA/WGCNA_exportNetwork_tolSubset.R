...
#TOM = TOMsimilarityFromExpr(datExprTol, power = 7);
...
#nTop = 30;
#IMConn = softConnectivity(datExprTol[, modProbes]);
...
TOM = TOMsimilarityFromExpr(datExprTol, power = 8);
# Read in the annotation file
...
cyt = exportNetworkToCytoscape(modTOM,
                               edgeFile = paste("CytoscapeInputTol-edges-", paste(modules, collapse="-"), ".txt", sep=""),
