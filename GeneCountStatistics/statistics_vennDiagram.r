...
v1 <- venn.diagram(list(Y05=SET1, Y023=SET2, E05=SET3, R2=SET4),
                  ...
                  filename=NULL)
jpeg("/home/mae/Documents/RNASeq_Workshop_ND/GeneCounts_Stats/plotOlympicsVenn.jpg")
grid.newpage()
grid.draw(v1)
dev.off()
...
v2 <- venn.diagram(list(Y05=SET1, Y023=SET2, E05=SET3, R2=SET4, PA=SET5),
                  ...
                  filename=NULL)
jpeg("/home/mae/Documents/RNASeq_Workshop_ND/GeneCounts_Stats/plotOlympicsPAVenn.jpg")
grid.newpage()
grid.draw(v2)
dev.off()
...
v3 <- venn.diagram(list(Y05=SET1, Y023=SET2, E05=SET3, R2=SET4, Sierra=SET6),
                   ...
                   alpha = c(0.5, 0.5, 0.5, 0.5, 0.5), cat.cex = 1.5, cex=1.5,
                   filename=NULL)
jpeg("/home/mae/Documents/RNASeq_Workshop_ND/GeneCounts_Stats/plotOlympicsSierraVenn.jpg")
grid.newpage()
grid.draw(v3)
dev.off()
...
v5 <- venn.diagram(list(Y023=SET2, R2=SET4, PA=SET5),
                   ...
                   alpha = c(0.5, 0.5, 0.5), cat.cex = 1.5, cex=1.5,
                   filename=NULL)
jpeg("/home/mae/Documents/RNASeq_Workshop_ND/GeneCounts_Stats/plotNonTolerantVenn.jpg")
grid.newpage()
grid.draw(v5)
dev.off()