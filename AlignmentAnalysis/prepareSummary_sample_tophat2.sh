...
#Usage: bash alignmentStats_prepareSummary.sh alignedSampleFolder alignmentMethod
#Usage Ex: bash alignmentStats_prepareSummary.sh alignment_topaht2_run2/140327_I481_FCC3P1PACXX_L4_Pool_3_Y05_UV topaht2
