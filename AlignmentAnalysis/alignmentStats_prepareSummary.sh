...
grep "is being aligned" "$inputStats" > "$outputStats_sampleOrder.txt"
...
#grep "were paired" "$inputStats" > "$outputStats_paired.txt"
...
grep "overall alignment rate" "$inputStats" > "$outputStats_overall.txt"
