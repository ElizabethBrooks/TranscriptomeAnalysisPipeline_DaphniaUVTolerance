...
if [[ "$1" == *"Trinity"* && "$2" != *"Trinity"* ]]; then
	...
	Rscript alignmentSummary_barPlotMedians_binnedCompareTarget.r "$inOutDir"/"$1" "$inOutDir"/"$2"
	...
	Rscript alignmentSummary_barPlotMedians_binnedCompareRun.r "$inOutDir"/"$1" "$inOutDir"/"$2"
	...
	Rscript alignmentSummary_barPlotMedians_binnedCompareSoftware.r "$inOutDir"/"$1" "$inOutDir"/"$2"
fi
