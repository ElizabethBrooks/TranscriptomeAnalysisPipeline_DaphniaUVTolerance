#!/bin/bash
#Usage: bash generateBarPlotsDriver_binnedMerged.sh percentsFile.csv
#Usage Ex: bash generateBarPlotsDriver_binnedMerged.sh alignmentSummarized_legacyTophat2Hisat2_differences_merged.csv
