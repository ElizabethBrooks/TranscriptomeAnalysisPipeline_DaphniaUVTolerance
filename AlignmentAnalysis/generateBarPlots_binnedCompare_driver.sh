...
mv "$inOutDir"/plotOverallPercentages.jpg "$outputAnalysis"/alignmentSummarized_"$outFile"_overallPercentages.pdf
mv "$inOutDir"/plotConcordantPercentages.jpg "$outputAnalysis"/alignmentSummarized_"$outFile"_concordantPercentages.pdf