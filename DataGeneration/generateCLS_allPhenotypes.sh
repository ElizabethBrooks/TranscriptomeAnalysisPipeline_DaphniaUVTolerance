#!/bin/bash
#Usage: bash generateCLS_allPhenotypes.sh
#Usage Ex: bash generateCLS_allPhenotypes.sh
...
outFile="$outputsPath"/dMelUV_allPhenotypes.cls
...
labelLine="Tol Tol Tol Tol Tol Tol Tol Tol Tol Tol Tol Tol NTol NTol NTol NTol NTol NTol NTol NTol NTol NTol NTol NTol NTol NTol NTol NTol NTol NTol Tol Tol Tol Tol Tol Tol"
