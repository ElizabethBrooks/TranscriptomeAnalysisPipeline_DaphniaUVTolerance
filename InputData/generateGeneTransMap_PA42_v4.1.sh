...
path=$(dirname /home/mae/Documents/RNASeq_Workshop_ND/genomicResources_PA42_v4.1/PA42.4.1.cds_longest.fasta)

grep ">" "$path"/PA42.4.1.pep_longest.fasta | sed "s/>//g" > "$path"/col1.txt
