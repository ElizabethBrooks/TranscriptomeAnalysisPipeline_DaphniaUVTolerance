...
hisat2 -q -p 8 -x aligned_hisat2_test/Daphnia_pulex.allmasked -1 "${FORWARDARRAY[*]}" -2 "${REVERSEARRAY[*]}" -S aligned_hisat2_test/output --summary-file alignedSummary_test.txt
