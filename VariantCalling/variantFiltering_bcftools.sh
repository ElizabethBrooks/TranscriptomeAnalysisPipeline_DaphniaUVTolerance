...
#Usage Ex: qsub variantFiltering_bcftools.sh sortedCoordinate_samtoolsHisat2_run3 genome variantCallingSamples_filteredMapQ
#Usage Ex: qsub variantFiltering_bcftools.sh sortedCoordinate_samtoolsHisat2_run3 genome variantCalling_filteredZS
