...
for f1 in trimmed/*pForward.fq.gz; do
	...
	tophat2 -p 8 -G TranscriptomeAnalysisPipeline_DaphniaUVTolerance/InputData/PA42.3.0.annotation.18440.gff -o aligned_tophat2/out/"${f1:8:${#f1}-23}" aligned_tophat2/Daphnia_pulex.allmasked $f1 "${f1:0:${#f1}-14}"pReverse.fq.gz
