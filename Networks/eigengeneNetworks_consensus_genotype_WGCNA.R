...
# usage: Rscript eigengeneNetworks_consensus_genotype_WGCNA.R workingDir minModuleSize
# usage ex: Rscript eigengeneNetworks_consensus_genotype_WGCNA.R /Users/bamflappy/PfrenderLab/OLYM_dMelUV/KAP4/WGCN_genotype_WGCNA 60
