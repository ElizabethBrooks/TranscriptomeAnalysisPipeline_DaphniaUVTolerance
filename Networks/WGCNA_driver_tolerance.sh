...
# WGCNA data input
Rscript dataInput_consensus_tolerance_WGCNA.R $outDir $inputCounts 1 24 $expDesign
...
Rscript pickSoftPower_consensus_WGCNA.R $outDir tolerance
...
#Rscript networkConstruction_consensus_tolerance_WGCNA.R $outDir 14 60
...
#Rscript networkAnalysis_consensus_WGCNA.R $outDir OLYM 60 tolerance
#Rscript networkAnalysis_consensus_WGCNA.R $outDir Tol 60 tolerance
#Rscript networkAnalysis_consensus_WGCNA.R $outDir NTol 60 tolerance
#Rscript networkAnalysis_consensus_WGCNA.R $outDir Y05 60 tolerance
#Rscript networkAnalysis_consensus_WGCNA.R $outDir Y023 60 tolerance
#Rscript networkAnalysis_consensus_WGCNA.R $outDir E05 60 tolerance
#Rscript networkAnalysis_consensus_WGCNA.R $outDir R2 60 tolerance

# WGCNA compare consensus eigengene networks
#Rscript eigengeneNetworks_consensus_tolerance_WGCNA.R $outDir 60
