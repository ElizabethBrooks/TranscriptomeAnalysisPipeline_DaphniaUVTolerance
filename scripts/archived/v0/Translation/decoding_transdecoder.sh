...
#Alternate usage Ex: qsub decoding_transdecoder.sh KAP4_cds ncbi longest
#Alternate usage Ex: qsub decoding_transdecoder.sh KAP4_transcripts ncbi longest
