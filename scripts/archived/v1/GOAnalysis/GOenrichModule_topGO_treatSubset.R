...
write.table(moduleBPResults, file="GOAnalysis/moduleTopGO_BPResults_treatSubset_signedNowick.csv", sep=",", row.names=FALSE)
write.table(moduleMFResults, file="GOAnalysis/moduleTopGO_MFResults_treatSubset_signedNowick.csv", sep=",", row.names=FALSE)
write.table(moduleCCResults, file="GOAnalysis/moduleTopGO_CCResults_treatSubset_signedNowick.csv", sep=",", row.names=FALSE)
