...
geneCountsE05 <- read.csv(file="/home/mae/Documents/RNASeq_Workshop_ND/genomicResources_PA42_v4.1/geneCounts_mergedHisat2_PA42_v4.1/exactTestE05Analysis_FDR0.10/exactTest_topTags_filtered.csv")
geneCountsY05 <- read.csv(file="/home/mae/Documents/RNASeq_Workshop_ND/genomicResources_PA42_v4.1/geneCounts_mergedHisat2_PA42_v4.1/exactTestY05Analysis_FDR0.10/exactTest_topTags_filtered.csv")
geneCountsY023 <- read.csv(file="/home/mae/Documents/RNASeq_Workshop_ND/genomicResources_PA42_v4.1/geneCounts_mergedHisat2_PA42_v4.1/exactTestY023_5Analysis_FDR0.10/exactTest_topTags_filtered.csv")
geneCountsR2 <- read.csv(file="/home/mae/Documents/RNASeq_Workshop_ND/genomicResources_PA42_v4.1/geneCounts_mergedHisat2_PA42_v4.1/exactTestR2Analysis_FDR0.10/exactTest_topTags_filtered.csv")
geneCountsPA <- read.csv(file="/home/mae/Documents/RNASeq_Workshop_ND/genomicResources_PA42_v4.1/geneCounts_mergedHisat2_PA42_v4.1/exactTestPAAnalysis_FDR0.10/exactTest_topTags_filtered.csv")
geneCountsSierra <- read.csv(file="/home/mae/Documents/RNASeq_Workshop_ND/genomicResources_PA42_v4.1/geneCounts_mergedHisat2_PA42_v4.1/exactTestSierraAnalysis_FDR0.10/exactTest_topTags_filtered.csv")
...
lt = list(UVT=SETDDR, E05=SETE05, Y05=SETY05, Y023=SETY023, R2=SETR2, PA=SETPA, Sierra=SETSierra)
m = make_comb_mat(lt)
