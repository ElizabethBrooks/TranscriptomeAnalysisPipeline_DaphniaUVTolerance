...
pdf(file="error_pValueRanges.pdf")
...
write.table(BP_GO_results_table, file="error_BP_GO_terms.csv", sep=",", row.names=FALSE, quote=FALSE)
write.table(MF_GO_results_table, file="error_MF_GO_terms.csv", sep=",", row.names=FALSE, quote=FALSE)
write.table(CC_GO_results_table, file="error_CC_GO_terms.csv", sep=",", row.names=FALSE, quote=FALSE)
...
write.table(BP_sigGO_results_table, file="error_BP_sigGO_terms.csv", sep=",", row.names=FALSE, quote=FALSE)
write.table(MF_sigGO_results_table, file="error_MF_sigGO_terms.csv", sep=",", row.names=FALSE, quote=FALSE)
write.table(CC_sigGO_results_table, file="error_CC_sigGO_terms.csv", sep=",", row.names=FALSE, quote=FALSE)
...
pdf(file = "error_TopSigGO_Density.pdf")
...
printGraph(BP_GO_data, BP_GO_results, firstSigNodes = 5, 
           fn.prefix = "error_BP_sigGO_subgraphs", useInfo = "all", pdfSW = TRUE)
printGraph(MF_GO_data, MF_GO_results, firstSigNodes = 5, 
           fn.prefix = "error_MF_sigGO_subgraphs", useInfo = "all", pdfSW = TRUE)
printGraph(CC_GO_data, CC_GO_results, firstSigNodes = 5, 
           fn.prefix = "error_CC_sigGO_subgraphs", useInfo = "all", pdfSW = TRUE)
